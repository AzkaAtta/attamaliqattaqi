const b = 'data-astro-transition-persist',
  Z = ['data-astro-transition', 'data-astro-transition-fallback'],
  O = new Set();
function $(e) {
...
function ee(e) {
  for (const t of e.scripts) !t.hasAttribute('data-astro-rerun') && $(t) && (t.dataset.astroExec = '');
}
function te(e) {
  const t = document.documentElement,
    n = [...t.attributes].filter(({ name: o }) => (t.removeAttribute(o), Z.includes(o)));
...
const re = () => {
  ...
  ae = (e, t) => e.getAttribute('props') === t.getAttribute('props'),
  ce = (e) => {
    (ee(e), te(e), ne(e));
    const t = re();
    (oe(e.body, document.body), t());
  },
  le = 'astro:before-preparation',
  ue = 'astro:after-preparation',
  fe = 'astro:before-swap',
  de = 'astro:after-swap',
...
class he extends U {
  ...
  loader;
  constructor(t, n, o, r, i, u, a, l, f, c) {
    (super(le, { cancelable: !0 }, t, n, o, r, i, u, a, l),
      (this.formData = f),
...
class pe extends U {
  ...
  swap;
  constructor(t, n) {
    (super(fe, void 0, t.from, t.to, t.direction, t.navigationType, t.sourceElement, t.info, t.newDocument, t.signal),
      (this.direction = t.direction),
      (this.viewTransition = n),
      (this.swap = () => ce(this.newDocument)),
      Object.defineProperties(this, {
...
async function ge(e, t, n, o, r, i, u, a, l) {
  const f = new he(e, t, n, o, r, i, window.document, u, a, l);
  return (
    document.dispatchEvent(f) &&
      (await f.loader(), f.defaultPrevented || (me(ue), f.navigationType !== 'traverse' && D({ scrollX, scrollY }))),
    f
  );
}
function we(e, t) {
...
const be = history.pushState.bind(history),
...
function Te() {
  ...
  for (const n of document.getElementsByTagName('script'))
    n.dataset.astroExec === void 0 && n.getAttribute('type') === 'module' && (t = n.getAttribute('src') === null);
...
const K = (e, t, n, o, r) => {
  ...
  if (e.href !== location.href && !r)
    ...
    } else be({ ...n.state, index: ++y, scrollX: 0, scrollY: 0 }, '', e.href);
  if (((document.title = u), (E = e), i || (scrollTo({ left: 0, top: 0, behavior: 'instant' }), (a = !0)), r))
    ...
    if (e.hash) {
      ...
      const l = history.state;
      ((location.href = e.href), history.state || (T(l, ''), i && window.dispatchEvent(new PopStateEvent('popstate'))));
...
function Ae(e) {
  ...
  for (const n of e.querySelectorAll('head link[rel=stylesheet]'))
    if (
      !document.querySelector(`[${M}="${n.getAttribute(M)}"], link[rel=stylesheet][href="${n.getAttribute('href')}"]`)
    ) {
...
async function G(e, t, n, o, r) {
  ...
  const a = await ge(t, n, e, u, o.sourceElement, o.info, i.controller.signal, o.formData, l);
  ...
  async function l(s) {
    ...
    if (s.formData) {
      ...
      h.body =
        t !== void 0 &&
        Reflect.get(HTMLFormElement.prototype, 'attributes', w).getNamedItem('enctype')?.value ===
          'application/x-www-form-urlencoded'
          ? new URLSearchParams(s.formData)
          : s.formData;
    }
    const m = await ve(p, h);
    if (m === null) {
      s.preventDefault();
      return;
    }
    ...
    const R = Ae(s.newDocument);
    R.length && !s.signal.aborted && (await Promise.all(R));
  }
  async function f() {
  ...
  if ((document.documentElement.setAttribute(H, a.direction), x))
    c.viewTransition = document.startViewTransition(async () => await _(a, o, c, r));
  else {
    const s = (async () => {
      (await Promise.resolve(), await _(a, o, c, r, j()));
    })();
    c.viewTransition = {
  ...
  (c.viewTransition?.updateCallbackDone.finally(async () => {
    ...
    c.viewTransition?.finished.finally(() => {
      ((c.viewTransition = void 0),
        c === g && (g = void 0),
        i === d && (d = void 0),
        document.documentElement.removeAttribute(H),
...
async function C(e, t) {
  await G('forward', E, new URL(e, location.href), t ?? {});
}
function Se(e) {
  if (!I() && e.state) {
    location.reload();
  ...
  const t = history.state,
    n = t.index,
    o = n > y ? 'forward' : 'back';
  ((y = n), G(o, E, new URL(location.href), {}, t));
}
const X = () => {
...
};
{
  ...
  for (const e of document.getElementsByTagName('script')) ($(e), (e.dataset.astroExec = ''));
}
const z = new Set(),
  A = new WeakSet();
let k,
  ...
  Y = !1;
function Re(e) {
  Y || ((Y = !0), (k ??= e?.prefetchAll), (J ??= e?.defaultStrategy ?? 'hover'), Le(), Pe(), ke(), xe());
}
function Le() {
...
function ke() {
  ...
  N(() => {
    for (const t of document.getElementsByTagName('a'))
      A.has(t) || (v(t, 'viewport') && (A.add(t), (e ??= De()), e.observe(t)));
  });
}
function De() {
  const e = new WeakMap();
...
function S(e, t) {
  ...
  if (Ie(e, n))
    if ((z.add(e), document.createElement('link').relList?.supports?.('prefetch') && t?.with !== 'fetch')) {
      const o = document.createElement('link');
...
(x || Ne() !== 'none') &&
  ...
  document.addEventListener('submit', (e) => {
    let t = e.target;
    if (t.tagName !== 'FORM' || e.defaultPrevented || B(t)) return;
    const n = t,
      o = e.submitter,
      r = new FormData(n, o),
